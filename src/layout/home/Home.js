      ...
      <div className='intro-card'>
        <div className='card card-background intro'>
          ...
          <div className='introduction-text'>
            <h3>Introduction</h3>
            <p>Back in 2018, I thought I would end up as a pilot.
              ...
              their messages with the world.</p>
            <p>I've had the privilege of producing, directing, shooting, and editing several projects within the
              Provo/SLC Music Scene over the last two years, and I'm looking forward with excitement towards the
              many projects to come this year!</p>
          </div>
        </div>
      </div>
    </div>
